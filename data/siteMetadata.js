...
const siteMetadata = {
  title: 'Bulk CTC for Everyone',
  author: 'Gray Cup Enterprises Pvt. Ltd.',
  headerTitle: 'Bulk CTC',
  description: 'A website from where you can buy Bulk CTC with ease.',
  language: 'en-IN',
  theme: 'light', // system, dark or light
  siteUrl: 'https://bulkctc.vercel.app',
  // siteRepo: 'https://github.com/timlrx/bulkctc',
  ...
  analytics: {
    ...
    // plausibleAnalytics: {
    //   plausibleDataDomain: '', // e.g. bulkctc.vercel.app
