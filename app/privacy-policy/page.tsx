...
export const metadata = genPageMetadata({
    ...
    description: 'Privacy Policy for Bulk CTC - Learn how Gray Cup Enterprises Pvt. Ltd. collects, uses, and protects your personal information.',
})
        ...
        <div className="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <div className="prose prose-lg max-w-none pb-8 pt-10 dark:prose-invert">
                <section className="mb-8">
                    <h2>Introduction</h2>
                    <p>
                        Welcome to Bulk CTC, operated by Gray Cup Enterprises Pvt. Ltd. ("we," "our," or "us").
